...
public class Appointment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(0, 91, 68));
        ...
        jLabel1.setForeground(new java.awt.Color(0, 91, 68));
        jLabel1.setText("Patient Name:");

        pNamelbl.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        pNamelbl.setForeground(new java.awt.Color(153, 153, 153));
        pNamelbl.setText("Patient Name");

        jLabel2.setFont(new java.awt.Font("arial", 1, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 91, 68));
        jLabel2.setText("Age:");

        pAgelbl.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        pAgelbl.setForeground(new java.awt.Color(153, 153, 153));
        pAgelbl.setText("Patient Age");

        pIdlbl.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        pIdlbl.setForeground(new java.awt.Color(153, 153, 153));
        pIdlbl.setText("Patient Id");

        pGenderlbl.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        pGenderlbl.setForeground(new java.awt.Color(153, 153, 153));
        pGenderlbl.setText("Patient Gender");

        jLabel7.setFont(new java.awt.Font("arial", 1, 20)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 91, 68));
        jLabel7.setText("ID:");

        jLabel8.setFont(new java.awt.Font("arial", 1, 16)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 91, 68));
        jLabel8.setText("Gender:");

        appointmentBtn.setBackground(new java.awt.Color(0, 139, 116));
        appointmentBtn.setFont(new java.awt.Font("arial", 1, 17)); // NOI18N
